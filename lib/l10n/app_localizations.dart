...
abstract class AppLocalizations {
  ...
  /// No description provided for @menu_play.
  ///
  /// In en, this message translates to:
  /// **'Play Undercover'**
  String get menu_play;
  ...
  /// No description provided for @label_accent_color.
  ///
  /// In en, this message translates to:
  /// **'Accent color'**
  String get label_accent_color;

  /// No description provided for @option_system_default.
  ///
  /// In en, this message translates to:
  /// **'System default'**
  String get option_system_default;

  /// No description provided for @option_theme_system.
  ///
  /// In en, this message translates to:
  /// **'Same as system'**
  String get option_theme_system;

  /// No description provided for @option_theme_light.
  ///
  /// In en, this message translates to:
  /// **'Light'**
  String get option_theme_light;

  /// No description provided for @option_theme_dark.
  ///
  /// In en, this message translates to:
  /// **'Dark'**
